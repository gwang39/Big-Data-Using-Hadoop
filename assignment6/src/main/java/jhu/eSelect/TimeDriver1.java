 ...
 * 2018/11/15
 */
public class TimeDriver1 extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        String sOption = conf.get("sOption");

            System.out.printf("Select - time: %s %s\n", inputPath, outputPath);
            job.setMapperClass(TimeMapper1.class);
